export function InvitationEmail({ agencyName, aoName, projectName, deadline, inviteUrl }: {
  agencyName: string
  aoName: string
  projectName: string
  deadline: string
  ...
  <tr><td align="center">
    <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;border:1px solid #E8E8E3">
      ...
      <tr><td style="padding:32px">
        <p style="margin:0 0 16px;font-size:20px;font-weight:600;color:#1A1A18">Invitation à répondre à un appel d'offre</p>
        <p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:#6B6B65"><strong style="color:#1A1A18">${agencyName}</strong> vous invite à soumettre une offre pour le projet <strong style="color:#1A1A18">${projectName}</strong>.</p>
        ...
        <table cellpadding="0" cellspacing="0" style="margin:0 auto 28px">
          <tr><td style="background:#1F6B44;border-radius:8px">
            <a href="${inviteUrl}" style="display:inline-block;padding:13px 32px;color:#fff;font-size:15px;font-weight:600;text-decoration:none">Créer mon compte et répondre</a>
          </td></tr>
        </table>
        <p style="margin:0;font-size:12px;color:#9B9B94;line-height:1.6">Ce lien est valide 48h après la date limite. Si vous n'attendiez pas cette invitation, ignorez cet email.</p>
      </td></tr>
    </table>
  </td></tr>
</table>
